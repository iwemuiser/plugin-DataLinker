...
jQuery(document).ready(function() {
    autocompleteAdd("43", "http://127.0.0.1/testing/resting/identifier.json?style=list&code=");     //identificatie code helper
    autocompleteExternal("52", "http://127.0.0.1/testing/resting/motif.json?style=list&code=");     //motif helper
    autocompleteExternal("49", "http://127.0.0.1/testing/resting/folktaletype.json?style=list&search=");//folktaletype helper
    dateTranslator("40");                           //date helper
    autocompleteExternal("39", "http://127.0.0.1/testing/resting/creator.json?style=list&search=");     //verteller(creator) helper
    autocompleteExternal("60", "http://127.0.0.1/testing/resting/collector.json?style=list&search=");   //verzamelaar helper
    //medewerker helper
    autocompleteExternal("93", "http://127.0.0.1/testing/resting/namedentities_location.json?style=list&search=");   //Named entities PLACES helper
    autocompleteExternal("63", "http://127.0.0.1/testing/resting/namedentities_other.json?style=list&search=");     //Named entities OTHER helper
    autocompleteExternal("65", "http://127.0.0.1/testing/resting/place_of_action.json?style=list&search=");         //plaats van handelen helper
    autocompleteExternal("67", "http://127.0.0.1/testing/resting/corpus.json?style=list&search=");         //CORPUS helper
    //kloekehelper??
